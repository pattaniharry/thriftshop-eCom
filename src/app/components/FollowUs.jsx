...
function FollowUs() {
  ...
  return (
    <div>
        ...
        <div className="main">
            <div className="container">
                <div className="FollowUs-wrapper pb-[111px]">
                    ...
                    <h3 className={`leading-[1.22] ${DMseri.className}`}>Follow us on instagram</h3>
                    </div>
        ...
        > 
          {images.map((items) => (
            <SwiperSlide key={items.index} className="w-[226px] mr-[10px]">
...
<div className="link-and-arrows pt-[24px] flex justify-between items-center">
  <Link href="/" >
    <div className="instagram-social flex ">
        <img src="images/insta_sm_icon.svg " className='mr-[9px]' alt="" />
