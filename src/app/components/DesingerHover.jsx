...
function DesignerHover({ show, onEnter, onLeave }) {
  ...
  return (
    <div className="main"   >
      ...
      onMouseLeave={onLeave} className=" absolute top-[88px] left-0 w-full bg-white z-50 shadow-md megamenu-wrapper pr-[80px] pl-[40px] border-t-1 border-[#c6c6c6] flex justify-between">
      ...
      <div className="flex gap ">
        ...
        <div>
          <ul className="space-y-2 text-sm text-gray-700 w-fit">
            ...
            <li className="hover:underline cursor-pointer">Alexander McQueen</li>
            ...
            <li className="hover:underline cursor-pointer">Comme des Garçons</li>
        ...
        <div className=' pl-[80px]' > 
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            ...
            <li className="hover:underline cursor-pointer">Louis Vuitton</li>
          </ul>
        </div>
        ...
        <div className=' pl-[80px]'> 
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            <li className="hover:underline cursor-pointer">Maison Margiela</li>
          ...
          <div className="all_links">
             <Link href="/" className=''><li className='pt-[30px]'> All Designer </li></Link>
          </div>
        </div>
      </div>
