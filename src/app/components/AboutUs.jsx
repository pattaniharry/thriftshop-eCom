  ...
  return (
    <div>
        ...
        <div className="StartSelling_block border-r-1 border-[#e2e2e2] ">
            ...
            <p className={`${inter.className}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam.</p>
        ...
        <div className="StartSelling_block "> 
            ...
            <p className={`${inter.className}`}>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.</p>
